  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              children: [
                IconButton(
                    ...
                    icon: CircleAvatar(
                        ...
                        child: const Icon(Icons.info_outline, color: Color(0xFF54A630),))),
                IconButton(
                    onPressed: () {},
                    icon: CircleAvatar(
                        radius: 20.r,
                        backgroundColor: Colors.black12,
                        child: const Icon(Icons.favorite_border,color: Color(0xFF54A630),))),
                IconButton(
                    onPressed: () {
                    ...
                    icon: CircleAvatar(
                        radius: 20.r,
                        backgroundColor: Colors.black12,
                        child: const Icon(Icons.create_new_folder_outlined,color: Color(0xFF54A630),))),
              ],
            ),
     ...
     children: [
       SizedBox(height: 5,),
       CustomText(
           title:"Design Name : ${productDetailsController!.productDetails_Model!.data!.attributes!.productName!}",
           fontSize: 18,
           fontWeight: FontWeight.w800, color: Color(0xFF54A630)
       ),
       const SizedBox(
         height: 4,
       ),
       ...
       Row(
         children: [
           ...
           SvgPicture.asset(AppIcon.bdTK, height: 14.h, color: Color(0xFF54A630)),
           const SizedBox(
             width: 4,
           ),
           // CustomText(
